...
void solve() {
    ...
    while (t--) {
        ...
        ll maxi=n-k+1;
        ll c=0;
        for(int i=maxi;i<n;i+=2)c++;
        ll ans=c+1;
        ll j=1;
        for(int i=maxi;i<n && j<=c;i+=2){
            if(a[i]!=j){
                ans=min(ans,j);
                j++;
                break;
            }
            if(maxi>1 && i+1<n && a[i+1]!=j+1){
                ans=min(ans,j+1);
                j++;
                break;
            }
        ...
        for(int i=maxi+2;i<n && j<=c;i+=2){
            if(a[i]!=j){
                ans=min(ans,j);
                j++;
                break;
            }
            if(maxi>1 && i+1<n && a[i+1]!=j){
                ans=min(ans,j);
                j++;
                break;
            }
        ...
        j=1;
        for(int i=1;i<n-maxi && j<=c;i+=2){
            if(a[i]!=j){
                ans=min(ans,j);
                j++;
                break;
            }
            if(maxi>1 && i+1<n-maxi+1 && a[i+1]!=j+1){
                ans=min(ans,j+1);
                j++;
                break;
            }
